...
static const char *const yytname[] =
{
  ...
  "CHAR", "ID", "NUM", "STRING", "CHARACTER_LITERAL", "IF", "ELSE",
  "WHILE", "DO", "FOR", "RETURN", "PRINT", "EQ", "NE", "LE", "GE", "INC",
  "DEC", "AND", "OR", "NOT", "'+'", "'-'", "'*'", "'/'", "'='", "';'",
  "'('", "')'", "'{'", "'}'", "$accept", "program", "statements",
  "statement", "declaration", "type", "compound_statement", YY_NULLPTR
};
...
{
       2,   -21,   -21,   -21,   -21,   -21,     2,    10,     2,   -21,
     -21,     4,   -21,    -3,   -21,   -21,   -20,   -21,   -21
};
...
{
       3,     4,     5,     6,     8,     3,     4,     5,     6,    13,
       0,     7,    32,     6,    -1,    -1,    -1,    -1,    -1,    -1,
...
{
       0,     3,     4,     5,     6,    32,    35,    38,    39,    40,
      41,    42,    43,    39,     0,    40,     7,    36,    32
};
...
#line 1285 "y.tab.c"
  ...
  case 13: /* compound_statement: '{' statements '}'  */
#line 133 "sus.y"
    {
        scope_start();
    }
